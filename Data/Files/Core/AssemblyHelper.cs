...
{
    /// <summary>
    /// Creates dynamic assembly and builds type of incoming <see cref="FileObjectData"/>
    /// </summary>
    internal class AssemblyHelper
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="Type"/> of incoming <see cref="FileObjectData"/>
        /// </summary>
        /// <param name="objectData"></param>
        /// <returns>A new created instance if creating of dynamic assembly has been successed; otherwise - NULL</returns>
        public Type? CreateTypeWithDynamicAssembly(FileObjectData objectData)
        {
