...
{
    public class ObjectFileHandlerTests
    {
        private ObjectFileHandler _handler;
        private Mock<ILogger<ObjectFileHandler>> _loggerMock;
        ...
        public void Setup()
        {
            ...
            _loggerMock = new Mock<ILogger<ObjectFileHandler>>();
            _handler = new ObjectFileHandler(_loggerMock.Object);
        }
        ...
        public void UpdateTest()
        {
            ...
            Global.UpdateDataDto = new FileObjectDataDto()
            {
