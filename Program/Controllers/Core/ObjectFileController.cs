...
namespace ClassCreator.Controllers.Core
{
    ...
    public class ObjectFileController : ControllerBase
    {
        private readonly ILogger _logger;
        private readonly IObjectHandler<FileObjectDataDto> _objectCreator;

        public ObjectFileController(ILogger<ObjectFileController> logger, IObjectHandler<FileObjectDataDto> objectCreator)
        {
            _logger = logger;
        ...
        [HttpPost("/add/")]
        public IActionResult PostObject(FileObjectDataDto objectDataDto)
        {
        ...
        [HttpPut("/{name}/")]
        public IActionResult UpdateObject(string name, FileObjectDataDto dto)
        {
